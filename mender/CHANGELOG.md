...
- *(api-gateway)* Switch tls certificate to k8s tls type
 ([3df6d0f](https://github.com/mendersoftware/mender-helm/commit/3df6d0f861049c55f3556fc3aa0cc8f47463bfa1)) 

- Enable featureGates parameter for the k8sTlsSecrets
 ([17b4150](https://github.com/mendersoftware/mender-helm/commit/17b41506ed8d8812807db13182300aaefcf4215c)) 
...
- Add http timeouts, only apply https timeouts when https is enabled
 ([c055454](https://github.com/mendersoftware/mender-helm/commit/c0554549b61b68c1947640420010b1c704fe909f)) 
...
- Bump to 5.7.1
 ([31044cd](https://github.com/mendersoftware/mender-helm/commit/31044cda55af5c3f349cc5dcdd4d48f72c4e5ae7))  by @oldgiova
- Bump default nats image to 2.9.20
 ([435ecea](https://github.com/mendersoftware/mender-helm/commit/435ecea91f65e4ad70be9f75970fd694dfd026d5))  by @oldgiova
...
- Bump to mender 3.7.4
 ([71f6773](https://github.com/mendersoftware/mender-helm/commit/71f6773a04dd96e5411f712ad9501e4b5a813d36))  by @oldgiova
...
([MEN-7162](https://northerntech.atlassian.net/browse/MEN-7162)) ([25ffc7e](https://github.com/mendersoftware/mender-helm/commit/25ffc7e742b9f4c5375d181befc6cc72af8b5cbc))  by @oldgiova
...
- Bump to Mender 3.7.3
 ([e71cb30](https://github.com/mendersoftware/mender-helm/commit/e71cb30aa7cf05107a98b4adb3cd62d1f70396d8))  by @oldgiova
...
- Bump traefik to v2.11.0
 ([d56bd47](https://github.com/mendersoftware/mender-helm/commit/d56bd47a8a09514239daa8660416e398ea07e110))  by @oldgiova
...
- Bump to v5.5.3
 ([622ae75](https://github.com/mendersoftware/mender-helm/commit/622ae7520689fb01f0c21182ff369dfda3ab291e))  by @oldgiova
...
- Bump traefik to 2.10.7
 ([4f623d3](https://github.com/mendersoftware/mender-helm/commit/4f623d3a57f54f36a8103bafc73f88e72a9fff12))  by @oldgiova
...
- Bump to version 3.7.1
 ([00c13de](https://github.com/mendersoftware/mender-helm/commit/00c13de9646fece25348c9c8dc0cdadc715d36a7))  by @oldgiova


  Chart version 5.4.1 with Mender version 3.7.1
...
- Upgrade to Mender 3.7.0, bump Helm chart version to 5.4.0
 ([a3d5b39](https://github.com/mendersoftware/mender-helm/commit/a3d5b39da10c0ace1413b47fdb9bd03821239651)) 
- Update the Redis settings to use a connection string
 ([e40d498](https://github.com/mendersoftware/mender-helm/commit/e40d498d44d893c29fa70c8c2fa9cd58b3b16f8e)) 
...
- Graceful shutdown for deviceconnect and terminationGracePeriodSeconds
 ([5a4f531](https://github.com/mendersoftware/mender-helm/commit/5a4f5310fcc821a6d931d079ff4c0e7df20d2bd6)) 
...
- Graceful shutdown for deviceconnect
 ([572c20d](https://github.com/mendersoftware/mender-helm/commit/572c20d4cf56cf6aaaba35b7d725d64db74fd582)) 
...
- Bump to version 5.2.6
 ([c5b0e53](https://github.com/mendersoftware/mender-helm/commit/c5b0e53b1ead9c0680d5a814bd3a5215039b16ea))  by @oldgiova
...
- Bump to version 5.2.5
 ([7d7cd03](https://github.com/mendersoftware/mender-helm/commit/7d7cd03bb073f3af5288336c4e782ace814a3bbc))  by @oldgiova
...
- Set Mender 3.6.2 image tags
 ([ee67fb6](https://github.com/mendersoftware/mender-helm/commit/ee67fb610d3820a99c7292602be7d891b6f15047)) 
...
- Use the `deployments.directUpload.jitter` parameter
 ([dfc8b6a](https://github.com/mendersoftware/mender-helm/commit/dfc8b6a5399685d7c7e81ab5193b455785184018)) 
...
- Add the `deployments.directUpload.skipVerify` parameter
 ([0009e08](https://github.com/mendersoftware/mender-helm/commit/0009e0878b2a26326d75f25cce6011acead4efec)) 
...
- Missing WORKFLOWS_NATS_URI in the db-migration-job
 ([bc39ccd](https://github.com/mendersoftware/mender-helm/commit/bc39ccd4ca34f460bf451cfd531e8e433aea6e41)) 
...
- Bump to build9
 ([0f381f2](https://github.com/mendersoftware/mender-helm/commit/0f381f2cae73c551970c4c47e828b3df1b553a63))  by @oldgiova
- Bump mender version to 3.6.0
 ([7219b4e](https://github.com/mendersoftware/mender-helm/commit/7219b4e3e92d8b0df5e80560fab868b18c0d7daf))  by @oldgiova
- Bump to version 5.0.2
 ([013cd76](https://github.com/mendersoftware/mender-helm/commit/013cd76c327d5d1acbc858613038968d2f3317d5))  by @oldgiova
...
([MEN-5972](https://northerntech.atlassian.net/browse/MEN-5972)) ([caa1633](https://github.com/mendersoftware/mender-helm/commit/caa1633c96b465a0dcbea72cb8353a0928bf883b)) 
...
- Upgrade to Mender 3.5.0
 ([bb5a0eb](https://github.com/mendersoftware/mender-helm/commit/bb5a0eba7bb70ab5fe89dfe90b6a2b01cb81c82e)) 
...
- *(gui-deploy)* Add imagePullSecrets
 ([23f53fd](https://github.com/mendersoftware/mender-helm/commit/23f53fddc6dc042e59c0f294a77b8f6be5df1b31)) 
...
- Iot-manager service is not enterprise-only
 ([8788de3](https://github.com/mendersoftware/mender-helm/commit/8788de3d7ac30067c01dfdb7fbfa7c5b4f398501)) 
- Remove duplicated env variable
 ([65574b6](https://github.com/mendersoftware/mender-helm/commit/65574b64194b2ec63eeceba2a242fd9e76463b70)) 
...
([MEN-5270](https://northerntech.atlassian.net/browse/MEN-5270)) ([87147f0](https://github.com/mendersoftware/mender-helm/commit/87147f0807a8fb27fc4c9f40ad4637dcad73a154)) 
...
([MEN-5270](https://northerntech.atlassian.net/browse/MEN-5270)) ([d4c02a5](https://github.com/mendersoftware/mender-helm/commit/d4c02a5f286230b06a0aff52092bb8339759fd56)) 


  Set a default average/burst rate limit of 100 requests per second.

- *(tenantadm)* Enable self-service sign-up if `hosted` is `true`
 ([fdf6382](https://github.com/mendersoftware/mender-helm/commit/fdf6382f916c71e7ffe5e744cd6c4f55a93bfa3c)) 

- Upgrade the Mender versions to the latest stable (3.2.1)
 ([3845212](https://github.com/mendersoftware/mender-helm/commit/3845212964cfd97081a1bfeda22775dfee26160e)) 
- Update default Docker tags to mender-3.2.2
 ([3303520](https://github.com/mendersoftware/mender-helm/commit/33035208ed6e6fe8ec2cd8374e36cc9e16ef676d)) 
- Add support for the AWS_EXTERNAL_URI deployments' setting
([MEN-5280](https://northerntech.atlassian.net/browse/MEN-5280)) ([a301c3e](https://github.com/mendersoftware/mender-helm/commit/a301c3e70ce2f1c9c7e69ef53eb65552df576ec9)) 
...
- Mender 3.3.0 release
 ([01cba03](https://github.com/mendersoftware/mender-helm/commit/01cba03e37e1ae10eaaca67adbde8b02c795a541)) 
...
- Set WORKFLOWS_NATS_URI for the components based on workflows
 ([26cad76](https://github.com/mendersoftware/mender-helm/commit/26cad76e7f00b50a608ebd21adb39cc98490c57c)) 
- Docker image name for tenantadm
 ([9d47ea1](https://github.com/mendersoftware/mender-helm/commit/9d47ea1b5ba7efcc822ba26e08ded450586131f5)) 
- Docker image for iot-manager in README
 ([26f64c4](https://github.com/mendersoftware/mender-helm/commit/26f64c42c3497d6ff6bf531040b4fbe3515f91a1)) 
...
- Install minio and mongodb from upstream charts instead of stable
 ([5bee4dc](https://github.com/mendersoftware/mender-helm/commit/5bee4dca5db22e009e0ebbf953c5adf2cb97ec3a)) 

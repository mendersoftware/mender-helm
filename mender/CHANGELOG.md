...
- *(devicemonitor)* Add base url for devicemonitor, needed for security email sending
([QA-1646](https://northerntech.atlassian.net/browse/QA-1646)) ([4a8faef](https://github.com/mendersoftware/mender-helm/commit/4a8faef0105ea1c0960a98fbca9724a72967f366))  by @merlin-northern
...
- Bump traefik from 3.6.4 to 3.6.5 in /mender
 ([653b8b5](https://github.com/mendersoftware/mender-helm/commit/653b8b5fd4b3eb0abb1ad2964cc30cb6b273fa38))  by @dependabot[bot]
...
## [6.0.0](https://github.com/mendersoftware/mender-helm/compare/mender-7.9.4...mender-6.0.0) (2026-07-20)
...
* added inventory addr to tenantadm pod template ([b308bfd](https://github.com/mendersoftware/mender-helm/commit/b308bfdf0dddbdfb46909402b427d688d66f9ed6))
...
* **devicemonitor:** add base url for devicemonitor, needed for security email sending ([4a8faef](https://github.com/mendersoftware/mender-helm/commit/4a8faef0105ea1c0960a98fbca9724a72967f366))
...
* bump redis from 8.4.0-alpine to 8.6.0-alpine in /mender ([d24644f](https://github.com/mendersoftware/mender-helm/commit/d24644fe20b748ab4f31e12e05f23e0c06a8a459))
...
* bump traefik from 3.6.2 to 3.6.4 in /mender ([061a672](https://github.com/mendersoftware/mender-helm/commit/061a672b52d2916ccb63d344094edfc8ee7a290e))
...
* bump traefik from 3.6.4 to 3.6.5 in /mender ([eefb6df](https://github.com/mendersoftware/mender-helm/commit/eefb6df1ae3f6740b599231a4bcb2f41b9480229))
* bump traefik from 3.6.4 to 3.6.5 in /mender ([653b8b5](https://github.com/mendersoftware/mender-helm/commit/653b8b5fd4b3eb0abb1ad2964cc30cb6b273fa38))
...
* bump traefik from v3.6.12 to v3.6.13 in /mender ([9dd41e5](https://github.com/mendersoftware/mender-helm/commit/9dd41e56cc58b91ebfdd6a2c3d550b71485c4ef7))
* bump traefik from v3.6.12 to v3.6.13 in /mender ([3ae14bb](https://github.com/mendersoftware/mender-helm/commit/3ae14bbe0d41092d24dd17ce74994ce6cd888294))
...
* bump traefik from v3.7.5 to v3.7.6 in /mender ([3fe8be6](https://github.com/mendersoftware/mender-helm/commit/3fe8be6d4a58ab93904086b70a876d126bdcdf2e))
* bump traefik from v3.7.5 to v3.7.6 in /mender ([b593832](https://github.com/mendersoftware/mender-helm/commit/b5938328b1555c5667739b406a7925faa961a2e6))
* bump traefik from v3.7.6 to v3.7.7 in /mender ([446a991](https://github.com/mendersoftware/mender-helm/commit/446a9915c5ed58ada1b12507be0f2c762b7caea2))
* bump traefik from v3.7.6 to v3.7.7 in /mender ([eb05bbe](https://github.com/mendersoftware/mender-helm/commit/eb05bbedba6f9c240281562f3b1bf243c02c545b))
...
* **deployments:** handle prerelease configmap ([88bdb0d](https://github.com/mendersoftware/mender-helm/commit/88bdb0d3129596b6f02c39ce43408a581a8b67e3))
* **deployments:** reload when configmap changes ([8d24ab4](https://github.com/mendersoftware/mender-helm/commit/8d24ab4c7bca7a11cba38740e28b295c2bdc7f68))
...
* device license count active by default ([76d2bb6](https://github.com/mendersoftware/mender-helm/commit/76d2bb66881b6f583705f0e2246f7a7170ce0cc7))
...
* remove invalid progressDeadlineSeconds from statefulset ([48a5a60](https://github.com/mendersoftware/mender-helm/commit/48a5a60ac913493ee0f03ed966e8a1d2605538e1))
* remove invalid progressDeadlineSeconds from statefulset ([1f814bb](https://github.com/mendersoftware/mender-helm/commit/1f814bbdf782132c7e427ca3652aa53f2d7ee5b5))
...
* release 6.0.0 ([e52e59a](https://github.com/mendersoftware/mender-helm/commit/e52e59a6ebba62612db6ac201caa226c1b606211))
...
## [7.9.0](https://github.com/mendersoftware/mender-helm/compare/mender-7.8.1...mender-7.9.0) (2026-07-06)

...
```bash
$ make package
$ helm install mender ./mender-3.0.2.tgz
```
...
```bash
$ helm install my-release -f values.yaml ./mender-3.0.2.tgz
```
...
| -------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------- |
| `global.auditlogs` | Enable the auditlog feature (requires enterprise) | `true` |
...
```bash
$ helm install --name my-release -f values.yaml ./mender-3.0.2.tgz
```
...
| `deployments.image.tag` | Docker image tag | `mender-3.0.2` |
...
| `device_auth.image.tag` | Docker image tag | `mender-3.0.2` |
...
| `gui.image.tag` | Docker image tag | `mender-3.0.2` |
...
| `inventory.image.tag` | Docker image tag | `mender-3.0.2` |
...
| `tenantadm.image.tag` | Docker image tag | `mender-3.0.2` |
...
| `useradm.image.tag` | Docker image tag | `mender-3.0.2` |
...
| `workflows.image.tag` | Docker image tag | `mender-3.0.2` |
...
| `create_artifact_worker.image.tag` | Docker image tag | `mender-3.0.2` |
...
| `auditlogs.image.tag` | Docker image tag | `mender-3.0.2` |
...
| `deviceconnect.image.tag` | Docker image tag | `mender-3.0.2` |
...
| `deviceconfig.image.tag` | Docker image tag | `mender-3.0.2` |

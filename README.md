...
```bash
$ make package
$ helm install mender ./mender-3.2.0.tgz
```
...
```bash
$ helm install my-release -f values.yaml ./mender-3.2.0.tgz
```
...
```bash
$ helm install --name my-release -f values.yaml ./mender-3.2.0.tgz
```
...
| `deployments.image.tag` | Docker image tag | `mender-3.2.0` |
...
| `device_auth.image.tag` | Docker image tag | `mender-3.2.0` |
...
| `gui.image.tag` | Docker image tag | `mender-3.2.0` |
...
| `inventory.image.tag` | Docker image tag | `mender-3.2.0` |
...
| `tenantadm.image.tag` | Docker image tag | `mender-3.2.0` |
...
| `useradm.image.tag` | Docker image tag | `mender-3.2.0` |
...
| `workflows.image.tag` | Docker image tag | `mender-3.2.0` |
...
| `create_artifact_worker.image.tag` | Docker image tag | `mender-3.2.0` |
...
| `auditlogs.image.tag` | Docker image tag | `mender-3.2.0` |
...
| `iot_manager.image.tag` | Docker image tag | `mender-3.2.0` |
...
| `deviceconnect.image.tag` | Docker image tag | `mender-3.2.0` |
...
| `deviceconfig.image.tag` | Docker image tag | `mender-3.2.0` |
...
| `devicemonitor.image.tag` | Docker image tag | `mender-3.2.0` |

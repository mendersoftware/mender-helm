...
```bash
$ make package
$ helm install mender ./mender-2.7.2.tgz
```
...
```bash
$ helm install my-release -f values.yaml ./mender-2.7.2.tgz
```
...
```bash
$ helm install --name my-release -f values.yaml ./mender-2.7.2.tgz
```
...
| `deployments.image.tag` | Docker image tag | `mender-2.7.2` |
...
| `device_auth.image.tag` | Docker image tag | `mender-2.7.2` |
...
| `gui.image.tag` | Docker image tag | `mender-2.7.2` |
...
| `inventory.image.tag` | Docker image tag | `mender-2.7.2` |
...
| `tenantadm.image.tag` | Docker image tag | `mender-2.7.2` |
...
| `useradm.image.tag` | Docker image tag | `mender-2.7.2` |
...
| `workflows.image.tag` | Docker image tag | `mender-2.7.2` |
...
| `create_artifact_worker.image.tag` | Docker image tag | `mender-2.7.2` |
...
| `auditlogs.image.tag` | Docker image tag | `mender-2.7.2` |
...
| `deviceconnect.image.tag` | Docker image tag | `mender-2.7.2` |
...
| `deviceconfig.image.tag` | Docker image tag | `mender-2.7.2` |

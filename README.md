...
```bash
$ make package
$ helm install mender ./mender-3.3.1.tgz
```
...
```bash
$ helm install my-release -f values.yaml ./mender-3.3.1.tgz
```
...
```bash
$ helm install --name my-release -f values.yaml ./mender-3.3.1.tgz
```
...
| `deployments.image.tag` | Docker image tag | `mender-3.3.1` |
...
| `device_auth.image.tag` | Docker image tag | `mender-3.3.1` |
...
| `gui.image.tag` | Docker image tag | `mender-3.3.1` |
...
| `inventory.image.tag` | Docker image tag | `mender-3.3.1` |
...
| `tenantadm.image.tag` | Docker image tag | `mender-3.3.1` |
...
| `useradm.image.tag` | Docker image tag | `mender-3.3.1` |
...
| `workflows.image.tag` | Docker image tag | `mender-3.3.1` |
...
| `create_artifact_worker.image.tag` | Docker image tag | `mender-3.3.1` |
...
| `auditlogs.image.tag` | Docker image tag | `mender-3.3.1` |
...
| `iot_manager.image.tag` | Docker image tag | `mender-3.3.1` |
...
| `deviceconnect.image.tag` | Docker image tag | `mender-3.3.1` |
...
| `deviceconfig.image.tag` | Docker image tag | `mender-3.3.1` |
...
| `devicemonitor.image.tag` | Docker image tag | `mender-3.3.1` |

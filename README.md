...
```bash
$ helm install --name my-release -f values.yaml ./mender-2.4.1.tgz
```

or using `helm3`:

```bash
$ helm install my-release -f values.yaml ./mender-2.4.1.tgz
```
...
| `api_gateway.image.tag` | Docker image tag | `mender-2.4.1` |
...
| `deployments.image.tag` | Docker image tag | `mender-2.4.1` |
...
| `device_auth.image.tag` | Docker image tag | `mender-2.4.1` |
...
| `gui.image.tag` | Docker image tag | `mender-2.4.1` |
...
| `inventory.image.tag` | Docker image tag | `mender-2.4.1` |
...
| `tenantadm.image.tag` | Docker image tag | `mender-2.4.1` |
...
| `useradm.image.tag` | Docker image tag | `mender-2.4.1` |
...
| `workflows.image.tag` | Docker image tag | `mender-2.4.1` |
...
| `create_artifact_worker.image.tag` | Docker image tag | `mender-2.4.1` |

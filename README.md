...
```bash
$ make package
$ helm install mender ./mender-3.3.2.tgz
```
...
```bash
$ helm install my-release -f values.yaml ./mender-3.3.2.tgz
```
...
```bash
$ helm install --name my-release -f values.yaml ./mender-3.3.2.tgz
```
...
| `deployments.image.tag` | Docker image tag | `mender-3.3.2` |
...
| `device_auth.image.tag` | Docker image tag | `mender-3.3.2` |
...
| `gui.image.tag` | Docker image tag | `mender-3.3.2` |
...
| `inventory.image.tag` | Docker image tag | `mender-3.3.2` |
...
| `tenantadm.image.tag` | Docker image tag | `mender-3.3.2` |
...
| `useradm.image.tag` | Docker image tag | `mender-3.3.2` |
...
| `workflows.image.tag` | Docker image tag | `mender-3.3.2` |
...
| `create_artifact_worker.image.tag` | Docker image tag | `mender-3.3.2` |
...
| `auditlogs.image.tag` | Docker image tag | `mender-3.3.2` |
...
| `iot_manager.image.tag` | Docker image tag | `mender-3.3.2` |
...
| `deviceconnect.image.tag` | Docker image tag | `mender-3.3.2` |
...
| `deviceconfig.image.tag` | Docker image tag | `mender-3.3.2` |
...
| `devicemonitor.image.tag` | Docker image tag | `mender-3.3.2` |
